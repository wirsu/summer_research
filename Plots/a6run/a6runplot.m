...
plot3(scurveperiodlog ,z_hccurve_unstable_max, x_hccurve_unstable_max, 'LineWidth', linewidth1, 'Color', red_color);

%plot3(epsi_hccurve_stable_max ,z_hccurve_stable_max, x_hccurve_stable_min, 'LineWidth', 1.5, 'Color', red_color);
plot3(scurveperiodlog2 ,z_hccurve_unstable_max, x_hccurve_unstable_min, 'LineWidth', linewidth1, 'Color', red_color);
%hccurve
