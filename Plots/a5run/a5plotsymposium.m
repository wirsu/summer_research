...
plot3(scurvelog ,z_scurve_unstable, x_scurve_unstable, 'LineWidth', linewidth1, 'Color', green_color, 'LineStyle', '--');

%plot3(epsi_scurve_stable1 ,z_scurve_stable1, x_scurve_stable1, 'LineWidth', 1.5, 'Color', blue_color);
plot3(scurvelog2 ,z_scurve_stable1, x_scurve_stable1, 'LineWidth', linewidth1, 'Color', green_color);

%plot3(epsi_scurve_stable2 ,z_scurve_stable2, x_scurve_stable2, 'LineWidth', 1.5, 'Color', blue_color);
plot3(scurvelog3 ,z_scurve_stable2, x_scurve_stable2, 'LineWidth', linewidth1, 'Color', green_color);
%scurve
...
plot3(scurveperiodlog ,z_hccurve_unstable_max, x_hccurve_unstable_max, 'LineWidth', linewidth1, 'Color', red_color, 'LineStyle', '--');

%plot3(epsi_hccurve_stable_max ,z_hccurve_stable_max, x_hccurve_stable_min, 'LineWidth', 1.5, 'Color', red_color);
plot3(scurveperiodlog2 ,z_hccurve_unstable_max, x_hccurve_unstable_min, 'LineWidth', linewidth1, 'Color', red_color, 'LineStyle', '--');
