...
%hccurve
plot3(epsi_hccurve_unstable_max ,z_hccurve_unstable_max, x_hccurve_unstable_max, 'LineWidth', 1.5, 'Color', red_color, 'LineStyle', '--');
%plot3(scurveperiodlog ,z_hccurve_unstable_max, x_hccurve_unstable_max, 'LineWidth', 1.25, 'Color', red_color, 'LineStyle', '--');

plot3(epsi_hccurve_unstable_max ,z_hccurve_unstable_max, x_hccurve_unstable_min, 'LineWidth', 1.5, 'Color', red_color, 'LineStyle', '--');
%plot3(scurveperiodlog2 ,z_hccurve_unstable_max, x_hccurve_unstable_min, 'LineWidth', 1.25, 'Color', red_color, 'LineStyle', '--');

%hccurve

%snpcurve
plot3(epsi_snpcurve_unstable ,z_snpcurve_unstable, x_snpcurve_unstable_max, 'LineWidth',  1, 'LineStyle', '--', 'Color', red_color);

plot3(epsi_snpcurve_unstable ,z_snpcurve_unstable, x_snpcurve_unstable_min, 'LineWidth', 1,  'LineStyle', '--', 'Color', red_color);
%snpcurve
